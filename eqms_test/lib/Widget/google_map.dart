...
class Google_MapState extends State<Google_Map> {
  ...
  void initState() {
    ...
    if (widget.mode == 1){
      client.getShelter().then((value){
        setState(() { // checked data. this get fine
          items = [
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: _isPermissionGranted ? buildGoogleMap() : buildPermissionDenied(),
    );
  }
  ...
  Future<Marker> Function(Cluster<Place>) get _markerBuilder =>
        ...
        return Marker(
          ...
          icon: await _getMarkerBitmap(cluster.isMultiple ? 125 : 90,
